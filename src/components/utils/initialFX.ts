...
function LoopText(Text1: TextSplitter, Text2: TextSplitter) {
  // The hero currently shows a single, static role, so the alternating
  // elements (.landing-h2-info-1 / .landing-h2-2) are not rendered.
  // Bail out instead of letting GSAP warn about missing targets.
